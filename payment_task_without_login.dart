...
main() {
  ...
  // login info
  String userName =
      "togrulagayev"; //yoxlamaq ucun terminala togrulagayev yazilmalidi
  String passWord = '1234'; // yoxlamaq ucun terminala 1234 yazilmalidi
  String userAddress;
    ...
    if ((productName != '' || productName != ' ') &&
      ...
      switch (userChoice) {
                ...
                case '2':
                  if (userCardBalance >= totalForKB) {
                    ...
                    switch (confirm) {
                      case 'Y':
                        print('Ilk ayin odenisi balansinizdan cixildi');
                        userCardBalance = userCardBalance - oneMonthKB3;
                        print(userCardBalance);
                        break;
                      case 'N':
                        print('Emeliyyat sona catdi.');
        ...
        case '2':
          ...
          print('Umumi odenilecek mebleg: ${totalPrice + cargoPrice} AZN');
          break;
        case '3':
          print('Mehsulunuz sizi gozleyir. Gun erzinde gelib goture bilersiz');
          break;
      }
    } else {
